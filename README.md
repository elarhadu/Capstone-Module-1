...
In this project, I designed a webpage with two pages .i.e. The Home page and the About page for the Ghana Movie Awards show.
...
Command : git clone git@github.com:elarhadu/Capstone-Module-1.git
